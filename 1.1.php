    ...
    foreach ($imgQuery as $imgOpt){
        ...
        switch  ($imgOpt['output']) {
            ...
            case 'slide211':
                ...
                break;     
            case 'slide311':
                $slide311 = $imgOpt['filename'];
                    break;     
            case 'slide411':
                $slide411 = $imgOpt['filename'];
                        break;     
            case 'slide511':
                $slide511 = $imgOpt['filename'];
                            break;                
...
<body>
    ...
    <div class = "Section2">
        <div class = "ImgCont">
            <div class="button">
             ...
             <button class="btnright" onclick="plusDivs(1)">&#10095;</button>
                ...
                <img class="mySlides" src="Resources/images/<?php echo $slide311 ?>" style="width:100%">
                <img class="mySlides" src="Resources/images/<?php echo $slide411 ?>" style="width:100%">
                <img class="mySlides" src="Resources/images/<?php echo $slide511 ?>" style="width:100%">
        ...
        <b>
            ...
            <li><a href = "tel:<?php echo $contact11 ?>"  class = "c13">&#128222; &nbsp;<?php echo $contact11  ?></a></li>
            <li><a href="mailto:<?php echo $email11 ?>" class = "c14">&#9993; &nbsp;<?php echo $email11  ?></a></li>
        </b>
    </div>
