...
<div class="container">
    ...
    <div class="welcome">
        <div class="row">
            ...
            <div class="animated fadeIn slideInRight slow col-6 carousel slide carousel-fade" data-ride="carousel" data-interval="4000">
        ...
        <div class="sws col-4">
            ...
            <div class="swsTip service-container z-depth-2">
                ...
                <li><a href="1.1.php">1.1 Information and Orientation Services</a></li>
                    <li><a href="1.2.php">1.2 Guidance and Counseling Services</a></li>
        ...
        <img src=<?php echo '"img/icons/' . $service3icon . '"' ?>>
            ...
            <div class="ispTip service-container z-depth-2">
                <ul>
                    ...
                    <li><a href="3.4.php">3.4 Health Service</a></li>
...
<div class="events">
    ...
    <?php
          $image = "https://hudyat.neu.edu.ph/";
          echo' <a href="'.$image.'"><img src="img/contents/' . $eventsimg . '" alt="">';
    ?>
</div>
