...
<body>
    ...
    <div class="Section1">
        ...
        <div class = "Info">
            <img src="ICON/<?php echo $welcomeimg22 ?>" class = "ILogo">
        
        </div>
        
        <div class = "S1C1">
        
            <p class = "h1"><?php echo $welcometextheader22 ?></p>
            <hr class = "rec1" color ="#006a4e ">
            <p class = "h2"><?php echo $welcometext22 ?></p>
   ...
   <div class = "Section2">
        <div class = "ImgCont">
            <div class="button">
             ...
             <button class="btnright" onclick="plusDivs(1)">&#10095;</button>
                ...
                <img class="mySlides" src="Resources/images/<?php echo $slide122 ?>" style="width:100%">
                <img class="mySlides" src="Resources/images/<?php echo $slide222 ?>" style="width:100%">
            </div>
            </div>
        </div>
        <div class = "S2C1">
        <b>
        <li><a href = "#" class = "c11"><?php echo $department22 ?></a></li>
            <li><a href = "#" class = "c12"><?php echo $mng22 ?></a></li>
            <li><a href = "tel:<?php echo $contact22 ?>"  class = "c13">&#128222; &nbsp;<?php echo $contact22 ?></a></li>
            <li><a href = "mailto:<?php echo $email22 ?>" class = "c14">&#9993; &nbsp;<?php echo $email22 ?></a></li>
        </b>
    </div>
    ...
    <div class="events ">
        ...
        src="<?php echo $embedUrl22 ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
    </div>
