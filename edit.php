        ...
        function pageSelect(){
            ...
            if(distext!='--Select Section to Edit--'){
                ...
                switch (distext) {
                    ...
                    case 'INFORMATION AND ORIENTATION SERVICES':
                    ...
                    case 'GUIDANCE AND COUNSELING SERVICES':
                    ...
                    case 'CAREER AND JOB PLACEMENT SERVICES':
                    ...
                    case 'ECONOMIC ENTERPRISE DEVELOPMENT':
                    ...
                    case 'STUDENT HANDBOOK DEVELOPMENT':
                        ...
                        case 'STUDENT ORGANIZATIONS AND ACTIVITIES':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'STUDENT COUNCIL GOVERNMENT':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'STUDENT PUBLICATION / YEARBOOK':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'SCHOLARSHIPS AND FINANCIAL ASSISTANCE':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'SAFETY AND SECURITY SERVICES':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'STUDENT HOUSING AND RESIDENTIAL':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'FOREIGN/ INTERNATIONAL STUDENTS SERVICES':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'SERVICES FOR SPECIFIC STUDENTS GUIDANCE':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'SPORTS DEVELOPMENT PROGRAMS':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
                        ...
                        case 'SOCIAL AND COMMUNITY INVOLVEMENT PROGRAMS':
                        document.getElementById('MainEditSection').style.display = 'none';
                        document.getElementById('1.1EditSection').style.display = 'none';
                        document.getElementById('1.2EditSection').style.display = 'none';
                        document.getElementById('1.3EditSection').style.display = 'none';
...
<div class="navbar">
   ...
   <!-- <a href="editUser.php">HOME</a>-->
  <a href="editUser.php">ADMIN</a>
  <a href="edit.php">EDIT PAGE</a>
  <a href="logs.php">ACTIVITY LOGS</a>
  <a href="main.php">NEU-OSAS</a>
  <a href="logout.php">LOGOUT</a>
  
</div>
            <div class='editHeader'>
                <h1>EDIT PAGE AND CONTENTS</h1>
            </div>
            ...
            <form action="editing.php"method="POST" onsubmit="return confirm('Are you sure you want to save?')">
                ...
                <option value="default">--Select Section to Edit--</option>
                    ...
                    <option value="Sect1.1">INFORMATION AND ORIENTATION SERVICES</option>
                    <option value="Sect1.1">GUIDANCE AND COUNSELING SERVICES</option>
                    <option value="Sect1.1">CAREER AND JOB PLACEMENT SERVICES</option>
                    <option value="Sect1.1">ECONOMIC ENTERPRISE DEVELOPMENT</option>
                    <option value="Sect1.1">STUDENT HANDBOOK DEVELOPMENT</option>
                    <option value="Sect1.1">STUDENT ORGANIZATIONS AND ACTIVITIES</option>
                    <option value="Sect1.1">LEADERSHIP TRAINING</option>
                    <option value="Sect1.1">STUDENT COUNCIL GOVERNMENT</option>
                    <option value="Sect1.1">STUDENT DISCIPLINE</option>
                    <option value="Sect1.1">STUDENT PUBLICATION / YEARBOOK</option>
                    <option value="Sect1.1">ADMISSION SERVICES</option>
                    <option value="Sect1.1">SCHOLARSHIPS AND FINANCIAL ASSISTANCE</option>
                    <option value="Sect1.1">FOOD SERVICES</option>
                    <option value="Sect1.1">HEALTH SERVICES</option>
                    <option value="Sect1.1">SAFETY AND SECURITY SERVICES</option>
                    <option value="Sect1.1">STUDENT HOUSING AND RESIDENTIAL</option>
                    <option value="Sect1.1">FOREIGN/ INTERNATIONAL STUDENTS SERVICES</option>
                    <option value="Sect1.1">SERVICES FOR SPECIFIC STUDENTS GUIDANCE</option>
                    <option value="Sect1.1">CULTURAL ARTS PROGRAMS</option>
                    <option value="Sect1.1">SPORTS DEVELOPMENT PROGRAMS</option>
                    <option value="Sect1.1">SOCIAL AND COMMUNITY INVOLVEMENT PROGRAMS</option>
                </select>
